-- 🚀 STRIPE-ONLY DATABASE MIGRATION (FIXED)
-- Complete migration from FreshBooks to Stripe-only architecture
-- FIXED: Handles view dependencies properly
...
-- ========================================
-- STEP 2: REMOVE FRESHBOOKS FIELDS & ADD STRIPE FIELDS
-- ========================================

-- 1. UPDATE PROJECT_MILESTONES TABLE
-- Remove FreshBooks field and add Stripe fields
...
-- Remove FreshBooks field and ensure Stripe fields exist
ALTER TABLE invoices 
DROP COLUMN IF EXISTS freshbooks_invoice_id;

ALTER TABLE invoices 
ADD COLUMN IF NOT EXISTS stripe_invoice_id VARCHAR UNIQUE,
ADD COLUMN IF NOT EXISTS stripe_customer_id VARCHAR;

-- 3. CREATE/UPDATE CUSTOMER_PROFILES TABLE FOR PHASE 2
-- This should align with the Stripe customer system
...
-- 4. ENSURE PROJECTS TABLE HAS CORRECT REFERENCES
...
-- ========================================
-- STEP 3: UPDATE INDEXES FOR STRIPE INTEGRATION
-- ========================================
...
-- ========================================
-- STEP 4: ENABLE ROW LEVEL SECURITY ON CUSTOMER_PROFILES
-- ========================================
...
-- ========================================
-- STEP 5: RECREATE VIEWS WITH STRIPE INTEGRATION
-- ========================================
...
✅ FreshBooks fields removed
✅ Stripe fields added to all tables
