...
-- Update customer relationship to use customer_profiles
-- ALTER TABLE projects 
-- ADD COLUMN IF NOT EXISTS customer_profile_id UUID REFERENCES customer_profiles(id);

-- ========================================
-- UPDATE INDEXES FOR STRIPE INTEGRATION
-- ========================================
...
-- View for Stripe payment status
...
Next Step: Remove FreshBooks code files' as result;